...
const coreCases = [
  ...
  { q: "tu peux me créer un dialogue de présentation, c'est Charlie qui doit dire \"Bonsoir à toutes et à tous ! Bienvenue dans La Charlie Roulette, la seule émission où même le règlement ne sait pas ce qu'il va se passer !\" et ajoute un effet spécial de ton choix et un emoji", mode: "action", expect: ["add_dialogue", "Bonsoir à toutes et à tous", "Charlie Roulette", "charlie", "laugh", "spotlights"], expectAny: ["emoji", "rire"], expectMode: "action", actionType: "command_batch", avoid: ["Victoria", "Kinza", "Barbaric", "Lolychou"] },
